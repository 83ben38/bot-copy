...
SCORING_CRITERIA = {
    ...
    "accuracy": "Does the response use and correctly cite the data provided without using any outside data? If the data provided is not relevant to the question, give the response of '0 * the information was not relevant to the question'",       # Completeness has slightly less weight
